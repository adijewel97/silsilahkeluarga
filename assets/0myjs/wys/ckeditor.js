                                    ...
                                    if (p.type == CKEDITOR.NODE_TEXT) G = p.getText(), d.test(G) && (p = null), r = /[\s\ufeff]$/.test(G);
                                        ...
                                        if (C && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                            ...
                                            if (d.test(G)) p = null;
                                                ...
                                                for (var H = p.$.getElementsByTagName("*"), w = 0, n; n = H[w++];)
                                    ...
                                    if ((0 < p.$.offsetWidth || b && p.is("br")) && !p.data("cke-bookmark"))
                                        if (C && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                            ...
                                            if (d.test(G)) p = null;
                                                ...
                                                for (H = p.$.getElementsByTagName("*"), w = 0; n = H[w++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[n.nodeName.toLowerCase()]) {
                                                        p = null;
                                                        break
                                                    }
                    ...
                    if (a.propertiesOnly || (d.valid = !0), d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)), d.allStyles || (d.allStyles = b(a.styles, c.styles, d.validStyles)), !d.allClasses) {
                        ...
                        if (a)
                            if (!0 === a) a = !0;
                                ...
                                for (var p = 0, e = c.length, m; p < e; ++p) m = c[p], h[m] || (h[m] = a(m));
                                a = !1
                            } else a = !1;
                        d.allClasses = a
                    }
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        ...
                        var p = void 0,
                            ...
                            f = void 0;
                        c = [];
                        for (e = 0; e < b.length; ++e) m = b[e], "string" == typeof m ? (m = m.split(/\s*:\s*/), g = m[0], q = null, f = m[1]) : (g = m.check, q = m.left, f = m.right), p || (p = m, p = p.element ? p.element : g ? g.match(/^([a-z0-9]+)/i)[0] : p.left.getDefinition().element), q instanceof CKEDITOR.style && (q = r(q)), c.push({
                            check: g == p ? null : g,
                            left: q,
            ...
            B.onTagOpen = function(e, m, g, f) {
                ...
                if (a(m)) y.push(m);
                    ...
                    if ("br" == e) F.push(m);
                        ...
                        else if (e in CKEDITOR.dtd.$listItem && !u(e, g)) B.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
        ...
        a.prototype = {
            ...
            exec: function(a, c) {
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    ...
                    n, w, f, x;
                for (x = 0; x < k; x++)
                    if (d && (n = c.type, w = c.name), f = l[x], !(a.nonEditable && !f.options.applyToAll || a.nestedEditable && f.options.excludeNestedEditable)) {
        ...
        var f = CKEDITOR.dom.walker.whitespaces(!0),
            ...
            q = function() {
                ...
                function b(c, d) {
                    ...
                    e = d.range.startPath();
                    for (var l = q[l.getName()], r = 0, k = c.getChildren(), C = k.count(), G = -1, n = -1, w = 0, K = e.contains(q.$list); r < C; ++r) e = k.getItem(r), a(e) ? (f = e.getName(), K && f in CKEDITOR.dtd.$list ? g = g.concat(b(e, d)) : (p = !!l[f], "br" != f || !e.data("cke-eol") || r && r != C - 1 || (w = (m = r ? g[r - 1].node : k.getItem(r + 1)) && (!a(m) || !m.is("br")), m = m && a(m) && q.$block[m.getName()]), -1 != G || p || (G = r), p || (n = r), g.push({
                        isElement: 1,
                        isLineBreak: w,
                ...
                function g(b, c, d, e) {
                    ...
                    (m = (new CKEDITOR.dom.walker(h)).next()) && a(m) && n[m.getName()] && (f = m.getPrevious()) && a(f) && !f.getParent().equals(b.startContainer) && d.contains(f) && e.contains(m) && m.isIdentical(f) && (m.moveChildren(f), m.remove(), g(b, c, d, e))
                }
                    ...
                    if (!I.checkReadOnly()) {
                        ...
                        if (K = D) {
                            ...
                            if ("text" == n.type && n.inlineStylesRoot) {
                                ...
                                for (I = n.inlineStylesRoot.getParent(); !u.equals(I);) v = v.appendTo(u.clone()), u = u.getParent();
                    ...
                    table: function() {
                        ...
                        return {
                            ...
                            detectRanges: function(e, h) {
                                ...
                                v = v.contains("table");
                                k = k.contains("table");
                                if (v || k) v && k && b(v, k) ? (e.tableSurroundingRange = g, g.setStartAt(v, CKEDITOR.POSITION_AFTER_END), g.setEndAt(k, CKEDITOR.POSITION_BEFORE_START), g = f.clone(), g.setEndAt(v, CKEDITOR.POSITION_AFTER_END), l = f.clone(), l.setStartAt(k, CKEDITOR.POSITION_BEFORE_START), l = a(g).concat(a(l))) : v ? k || (e.tableSurroundingRange = g, g.setStartAt(v, CKEDITOR.POSITION_AFTER_END), f.setEndAt(v, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = g, g.setEndAt(k, CKEDITOR.POSITION_BEFORE_START), f.setStartAt(k, CKEDITOR.POSITION_AFTER_START)), e.tableContentsRanges = l ? l : a(f)
                            },
