                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                     <!--  <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                        ...
                        <!-- <li><i class=""></i></a><li><a class=""><i class=""></i>
                        <li><i class=""></i></a><li><a class=""><i class=""></i>
                        <li><i class=""></i></a><li><a class=""><i class=""></i>
                        <li><i class=""></i></a><li><a class=""><i class=""></i> -->
                      <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" align="right"><i class="fa fa-gear"></i></a>
                    ...
                    <div class="form-body"> 
                        <div class="row">
                            <div class="col-md-12 col-sm-2 col-xs-12" style="font-size: 10px">
                                <div class="form-group">
                                    <div class="radio">
                                        <div class="col-md-12 col-sm-4 col-xs-12">
                                             <label>
                                              <input type="radio" value="L" id="L" name="v_kelamin"> Laki-laki
                                            </label>
                                        </div>
                                        <div class="col-md-12 col-sm-4 col-xs-12">
                                            <label>
                                              <input type="radio" value="P" id="P" name="v_kelamin"> Perempuan
                                            </label>
                                        </div>
                                        <div class="col-md-12 col-sm-4 col-xs-12">
                                            <label>
                                              <input type="radio" value="U" id="U" name="v_kelamin"> Tidak dikenal
                                            </label>
                                        </div>
                                    </div> 
                                </div> <br/>
                                <div class="form-group">
                                        <label>Ayah/Ibu</label>
                                        <select name="v_parent" id="v_parent" class="form-control">
                                        </select>
                                    </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" id="v_kota_tinggal" class="form-control" name="v_kota_tinggal" required placeholder="Tempat Lahir"/>
                                </div>
            ...
            <div class="modal-body">
                <form id="form-Silsilah-foto"  method="post" enctype="multipart/form-data" >
                    ...
                    <div class="form-body"> 
                        ...
                        <div class="modal-footer">
                          <button type="button" class="btn btn-primary btn-xs" id="btn_simpan_silsilah_foto" onclick="simpan_silsilah_foto()" >Simpan</button>
                          <button id="closemodal" type="button" class="btn btn-default btn-xs" data-dismiss="modal">Keluar</button>
                        </div>
                    </div>
                </form>
           ...
           //alert(myproses);
            ...
            $.ajax ({
                ...
                success: function(data) {
                    ...
                    $('#v_kota_tinggal').val(data.kota_tinggal);
                    ...
                    combo_data_parent(data.id_parent);
            ...
            combo_data_parent(my_id_parent);
        } else {
          //alert(myproses);
          $.ajax ({
                url: "<?php echo base_url(); ?>index.php/Silsilah/show_silislah_label_id",
            ...
            $.ajax ({
                ...
                success: function(data) {
                   ...
                   //foto_path
                    ...
                    var link_page  =  '<?php echo base_url()?>'+'arsip/images/fotoindvidu/'+data.foto_path; 
                    $('#n_myfoto_edit').html('');
            ...
            $.ajax ({
                ...
                success: function(data) {
                    //alert('hello');
                      ...
                      $('#v_kota_tinggal').html(data.kota_tinggal);
            ...
            success: function(msg) {
                ...
                if (msg.status=='1') {
                  ...
                  if ( myproses == '3') {
                    ...
                    showsilsilah();
                    show_table_keluarga();
                    show_data_proses_from('2',myid_relasi);
                    show_data_proses('2',myid_relasi);
                  }
                }
            }
        });
    ...
    function simpan_silsilah_foto(){
     ...
     var mydata;
        ...
        $.ajax ({
            ...
            dataType: "JSON",
            beforeSubmit: function() {
                $('#btn_simpan_silsilah_foto').attr('disabled', 'disabled');
                $('#btn_simpan_silsilah_foto').button('loading');
            },
            success: function(msg) {
                //console.log(msg.status);
                var mykey = $('#v_id_f').val()+"|"+$('#v_id_relasi_f').val();
                $('#btn_simpan_silsilah_foto').removeAttr('disabled');
                $('#btn_simpan_silsilah_foto').button('reset');
    ...
    function showsilsilah(){
      $.ajax ({
          ...
          success: function(data) {
            ...
            var data_ary = [];
            //data_ary.push(root: {"id"      : id_key, expanded: true});
            // begin get data from db 
            data_ary.push(
                           {  "id"      : "",  "parentId" : "" , "view"     :  "", 
                              "title"   : "" , 
                              "image"   : "", "contact"  : "", "pseudo" : eval("true"), 
                              "id_relasi"  : ""  }
                          );           
            for (var key in data.kelurga) {   
                //alert(data.kelurga[key].tempat_lahir) //alert Anushka, Shreya, Kajal
                //buat ayah
                var myparent
                ...
                var id_key_parent_abs   = data.kelurga[key].id_parent_abs;
                
                var pseudo_key          = data.kelurga[key].pseudo;
                var id_relasikey        = data.kelurga[key].id_relasi;
                var link_foto           = '<?php echo base_url()?>'+'arsip/images/fotoindvidu/'+data.kelurga[key].foto_path;
                var kota_tinggal        = data.kelurga[key].kota_tinggal;

                if ( id_relasikey == '3' ) {
                  var nama_view          = data.kelurga[key].nama_view + ' (Suami/Istri)';  
                  //var nama_view          = '<i class="fa fa-link"></i>fa-link </a>';
                } else {
                  var nama_view          = data.kelurga[key].nama_view;
                }
                

                if ( id_key_parent_abs == null || id_key_parent_abs == '' ) {
                    data_ary.push(
                           {  "id"      : id_key,  "parentId" : "" , "view"     :  nama_view, 
                              "title"   : umur+" | "+ttl , 
                              "image"   : link_foto, "contact"  : kota_tinggal.toUpperCase() , "pseudo" : eval(pseudo_key), 
                              "id_relasi"  : id_relasikey  }
                          );
                } else {
                    data_ary.push(
                           {  "id"      : id_key,    "parentId" : id_key_parent_abs,  "view"     : nama_view , 
                              "title"   : umur+" | "+ttl , 
                              "image"   : link_foto, "contact"  : kota_tinggal.toUpperCase() , "pseudo" : eval(pseudo_key), 
                              "id_relasi"  : id_relasikey  }
                          );
            ...
            console.log( JSON.stringify(data_ary) );
            //convert ke array objek string
            var options = {
              childKey      : 'id',
              parentKey     : 'parentId',
              viewkey       : 'view',
              ...
              imagekey      : 'image',
              pseudokey     : 'pseudo',
              id_relasikey  : 'id_relasi'
            };
            var tree = walkTree(listToTree(data_ary, options), pruneChildren);
            //document.body.innerHTML = '<pre>' + JSON.stringify(tree, null, 4) + '</pre>';
            
            var mytree =  JSON.stringify(tree, null, 4);
            console.log(mytree);

            //convert string array ke objek
            var myobj = JSON.parse(mytree);
            // begin Buat diagram graph
            //-----------------------------------------------------------------------------            
...
// ================================================================================================================= 
    function listToTree(list, options) {
      ...
      //---------------------------------------------
      var viewkey     = options.viewkey     || 'view';
      var titlekey    = options.titlekey    || 'title';
      var imagekey    = options.imagekey    || 'image';
      var contactkey  = options.contact     || 'contact';
      var pseudokey   = options.pseudo      || 'pseudo';
      var id_relasikey= options.id_relasi   || 'id_relasi';
      //var htmlobject = $(s);
      
      var nodeFn      = options.nodeFn      || function(node, name, viewkey, titlekey, 
                        imagekey, pseudokey, contactkey, id_relasikey, 
                        children) {
        if (pseudokey   == '' || typeof pseudokey   == 'undefined') { pseudokey = false;} else {pseudokey = true;};
        if (contactkey  == '' || typeof contactkey  == 'undefined') { contactkey = '';} else {contactkey = contactkey;};
        if (childKey == 'child') {
           var conectorkey = {
                              type: "step",
                              style: {
        ...
        return {  connectors: conectorkey,
                  ...
                  HTMLid    : name,
                  link      : {
                                  href: "javascript:show_data_proses('2','"+ name +"|"+ id_relasikey +"')",
                              },
                };
      };
      var nodeCache = {};
      return list.reduce(function(tree, node) {
        ...
        if (typeof node[parentKey] === 'undefined' || node[parentKey] === '') {
          ...
          parentNode[childrenKey].push(nodeFn(node, 
            node[childKey],  
            node[viewkey],
            node[titlekey], 
            node[imagekey],
...
// ================================================================================================================= 
    function combo_data_parent(kdktrpusat) {
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/Silsilah/combo_data_parent",
            type: "POST",
            dataType: "JSON",
            success: function(data){
                $("#v_parent").html(data.data+data.data1);
                $('#v_parent option[value='+kdktrpusat+']').attr('selected', 'selected'); 
            }
        });
    }
        /*data = {"employees":[
